    ...
    <Container>
       <Card>
        <div class="flex justify-end mb-4">
          <JetButton  class="mb-1 float-right"  @click="getStudent">Select All</JetButton>
            ...
            <div class="flex justify-center">
              <template v-for="(link, key) in students.meta.links" :key="key">
                  <jet-nav-link
                      :href="link.url"
                    >
                      <b v-if="link.active === false" v-html="link.label" class="mb-1 mr-1 px-4 py-3 text-gray-400 text-sm leading-4 border rounded"></b>
