            ...
            <div class="px-4 pb-0">
              ...
              >
                ...
                <div class="grid grid-cols-2">
                  ...
                  <div class="ml-4 mt-2 border-1 border-gray-700">
                    <!--
                    <AppImage
                      class="mt-2 rounded-none"
                      v-model="form.logo"
                      :image-url="pathImage + logoUrl"
                      :addClassImage="addClassImage"
                      :clearImage="clearImage"
                      v-on:eventRemoveImage="removeImage"
                      label="Logo"
                    /> -->
<!--========================================================================================================================================================-->
                  <div class="">
...
<!--========================================================================================================================================================-->
                ...
                <div class="grid grid-cols-2 mt-2">
                  <div class="border-1 border-gray-700">
                    <!-- <AppImage
                      class="mt-1 rounded-none"
                      v-model="form.image_header"
                      :image-url="pathHeader + imageHeader"
                      :addClassImage="addClassImageHeader"
                      :clearImage="clearImage"
                      label="Image Header"
                    /> -->
                     <div>
                 ...
                 <div class="ml-1 border-1 border-gray-700">
                    <!--  <AppImage
                      class="mt-1 rounded-none"
                      v-model="form.image_footer"
