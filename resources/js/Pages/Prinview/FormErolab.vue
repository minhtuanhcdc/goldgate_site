                          ...
                          <div class="py-0 flex">
                            ...
                            <div class=" text-center font-sans-Timenew leading-5 fontsizeElement w-80">
                              <p class="-mt-1  flex justify-center">
                                <vue-barcode class="h-8 w-44" :value="getbilltests['thinprep_code']" :options="{ displayValue: false }"></vue-barcode>
                              </p>
        ...
        <div>
          ...
          <div class="border-2 border-black px-2 py-3 text-blue-700 ">
              ...
              <div class="flex flex-cols-5 fontsizeElement">
                   ...
                   <div class="font-bold mt-2 p-0 font-sans-Timenew fontsizeElement">Ghi chú (Notes):</div>
          </div>
              <div class="grid grid-cols-3">
                              <div class="col-span-2">
                               ...
                               <div class="grid grid-cols-1 text-center fontsizeInfo">
                                  ...
                                  <span class="mb-32 font-bold font-sans-Timenew ">BS GPBL - TB</span>
