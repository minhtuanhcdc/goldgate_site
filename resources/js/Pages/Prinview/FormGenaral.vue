...
<div><h4>Form group Chung</h4>
 <div class="pl-2" ref="printMe" id="printMe" >
                      <div class="grid grid-cols-8 mx-0 py-0 mb-2">
                          <div class="col-span-1 py-0">
                          ...
                          <div class="col-span-2 text-right text-italy text-sm font-bold font-sans-Timenew  -mt-2 w-full">
                            ...
                            <div class="grid grid-cols-3">
                              <div class="col-span-2">
                               ...
                               <div class="grid grid-cols-1 text-center">
                                  ...
                                  <span class="mb-20 font-bold font-sans-Timenew text-md">BS/KTV đọc kết quả:</span>
