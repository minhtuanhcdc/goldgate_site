 ...
 <div class="m-0 p-0" v-for="(td,i) in getbilltests" :key="i">
    <div>
      ...
      <div>
        ...
        <div class=" font-bold text-sm font-sans-Timenew mt-1 text-red-600 py-0">KẾT QUẢ TẾ BÀO HỌC CỔ TỬ CUNG THEO HỆ THỐNG BETHESDA 2014</div>
        ...
        <div class="flex justify-between">
          <div class="flex flex-col">
            ...
            <div  v-for="eg9 in testElements" :key="eg9.id" class="w-full">
              <div class="font-bold text-xs" v-if="eg9.element_group ==9 && eg9.element_group !==null ">
          ...
          <div class="flex justify-between text-center text-sm">
            ...
            <div class="flex flex-col justify-center">
              ...
              <span class="font-bold font-sans-Timenew fontsizeName">BS GPBL - TB</span>
