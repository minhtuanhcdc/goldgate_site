     ...
     <div class="w-full" ref="printMe" id="printMe" style="@media print:{margin:0; padding:0;}">
                    ...
                    <div>
                         ...
                         <div class="text-left font-bold text-sm  font-sans-Timenew mt-1 text-blue-800 leading-5">LOAI BỆNH PHẨM
                          <span class="pl-5 text-blue-600 mr-0 pr-0 text-sm">Tế bào học nhúng dịch ThinPrep</span><span class="text-blue-600 align-top ml-0 p-0">&reg;</span></div>
        ...
        <div class="grid grid-cols-2 text-center text-sm">
                    ...
                    <div>
                                ...
                                <p class=" font-sans-Timenew " style="margin-bottom:70px">BS/KTV đọc kết quả:</p>
                                  <span class="font-bold font-sans-Timenew text-lg fontsizeInfo" v-if="td.doctorread">{{td.doctorread.title}}<span class="ml-1 uppercase "> {{td.doctorread.name}}</span></span>
                    </div>
          </div>
    </div>
  </div>
