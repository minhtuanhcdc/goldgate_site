    ...
    <div>
      ...
      <div class="flex justify-between mb-2">
        <div class="flex flex-1">
          <div class="flex flex-row w-56 px-4 justify-center">
              <a :href="route('exportbill',{'startDate':startDate,'endDate':endDate,'ousentFill':ousentFill,'readcodeFill':readcodeFill,'nametestFill':nametestFill,'resultHpvFill':resultHpvFill })" class="text-center py-2 flex flex-row justify-center bg-blue-600 text-white w-full rounded-md mr-2" >
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex flex-col">
          <div class="flex flex-row mb-1 items-center">
            <span class="text-blue-800 w-20">Từ ngày:</span>
                <jet-input
                id="startDate"
                type="date"
                class="h-8 block flex-1 bg-yellow-200"
                v-model="startDate"
                autocomplete="startDate"/>
          </div>
            <div class="flex flex-row ">
              <span class="text-blue-800 w-20">Đến:</span>
              <jet-input
                id="endDate"
                type="date"
                class= "h-8 block flex-1 bg-yellow-200 "
        ...
        <div class="flex flex-col items-center">
          <div class="">
            <span class="text-blue-800">Kết quả HPV:</span>
          </div>
          <div class="2">
            <select
              name="testgroup"
    ...
    headers() {
      return [
        ...
        { name: "Mã HPV", class:'border-l-2 text-center font-normal' },
         ...
         { name: "Mã phụ", class:'border-l-2 text-center font-thin' },
