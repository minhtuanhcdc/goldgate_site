<div class="container-fluid " style="padding:20px; margin-top:10px">
        <table class="table borderless " style="padding:20px 0px 20px 20px">
            <tbody>
                ...
                <tr >
                    <td style="border:none !important" class="py-0" colspan="4"><span>Đơn vị gửi(Custommer): </span><span class="font-bold">{{$value->ousent->name}}</span></td>
                ...
                <tr >
                    ...
                    <td style="border:none !important" colspan="3" class="py-0">Bác sỹ chỉ định (Physician):
                        @if($value->doctor)
